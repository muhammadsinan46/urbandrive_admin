...
import 'package:ud_admin/features/inbox_screen/pages/inbox_screen.dart';
import 'package:ud_admin/features/dashboard/pages/ud_dashboard.dart';
                ...
                CollapsibleItem(
                  ...
                  onPressed: () {
                    BlocProvider.of<SlidebarBloc>(context)
                        .add(SlidebarChangeEvent(index: 0));
                  },
                ),
                CollapsibleItem(
                  text: "Customers",
